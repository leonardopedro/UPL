...
\uplsetup
\catcode`\{=12 \uplinline$  theory HilbertSpace {$ \catcode`\{=1
...
This function takes a vector \texttt{v} and a coordinate index \texttt{k}, returning the \texttt{k}-th coordinate as a \texttt{complex} number (a Cauchy sequence). This allows functions to work with a finite number of arguments, where each argument represents an infinite-dimensional object accessed through the index.
...
\catcode`\}=12 \uplinline$  }$ \catcode`\}=2
\end{smodule}
...
\catcode`\{=12 \uplinline$  theory HarmonicOscillator {$ \catcode`\{=1
...
\catcode`\{=12 \uplinline$  theory OperatorAlgebra {$ \catcode`\{=1
...
\catcode`\{=12 \uplinline$  theory ESA_Definitions {$ \catcode`\{=1
...
\catcode`\{=12 \uplinline$  theory HO_Analysis {$ \catcode`\{=1
...
\catcode`\{=12 \uplinline$  theory QFT_Model {$ \catcode`\{=1
...
\catcode`\{=12 \uplinline$  theory AlgebraicTranscendentals {$ \catcode`\{=1
\uplinline$    include HilbertSpace$
\uplinline$    $
